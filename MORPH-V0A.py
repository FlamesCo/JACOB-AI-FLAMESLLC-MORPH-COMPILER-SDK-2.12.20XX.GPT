...
class TextEditor(tk.Tk):
    ...
    def initUI(self):
        ...
        self.title("MORPH [COMPILER] - Flames LLC 0.X")
        ...
        self.language_dropdown = tk.OptionMenu(self, self.language_var, "Python", "HTML", "C#", "Rust", "Morph Compiler LANG","Assembly","Autotranslate","Query Google", "OpenAI CODEX (BETA)")
